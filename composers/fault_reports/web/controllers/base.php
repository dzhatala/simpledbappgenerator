...
require_once __DIR__.'/one2many_lfr_fp/index.php';
...
require_once __DIR__.'/fault_picture/index.php';
require_once __DIR__.'/lamp_fault_report/index.php';
require_once __DIR__.'/rr_permission/index.php';
require_once __DIR__.'/ur_permission/index.php';
require_once __DIR__.'/uri_permission/index.php';
